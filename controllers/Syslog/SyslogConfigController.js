/**
 * @fileoverview Syslog configuration endpoints — get/update the syslog
 * configuration, list facilities/levels, and validate configuration content.
 * @author Mark Gilbert
...
import { parseSyslogConfig, validateSyslogConfigContent } from './utils/SyslogParsingHelpers.js';

/**
 * @fileoverview Time Sync System Switch Manager for Time Synchronization Operations
 * @description Handles switching between time synchronization systems (ntp, chrony, ntpsec)
...
export const generateConfigForSystem = (targetSystem, servers) => {
  ...
  switch (targetSystem) {
    case 'ntp':
      baseConfig = `# Generated by Zoneweaver Agent - System Switch

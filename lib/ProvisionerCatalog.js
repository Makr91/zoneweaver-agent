...
/**
 * The one refusal wording for an unresolvable catalog source (controller
 * 404s and the install task share it).
 * @param {string} [name] - The requested source name ('' / undefined = none)
 * @returns {string} Error message
 */
export const catalogSourceError = name =>
  name
    ? `catalog source '${name}' is not configured or disabled`

 ...
 * files): {source_type: 'git', url, branch?} recorded by git imports so
 * refresh-from-source can re-run the ordinary import later. Families from
 * folder/archive/catalog imports carry none.
 */

/**
 * @fileoverview SSL Certificate Manager for Zoneweaver Agent
 ...
 * @returns {import('https').Server|null} The HTTPS server, or null when SSL is disabled or setup fails
 */
